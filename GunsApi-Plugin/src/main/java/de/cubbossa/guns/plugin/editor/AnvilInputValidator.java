...
public class AnvilInputValidator<T> {
	...
	public static final AnvilInputValidator<String> VALIDATE_TAG = new AnvilInputValidator<>(Messages.ERROR_PARSE_STRING,
	...
	public static final AnvilInputValidator<Duration> VALIDATE_DURATION = new AnvilInputValidator<>(Messages.ERROR_PARSE_DURATION,
			Component.text(TextUtils.DURATION_FORMAT), PREDICATE_DURATION, s -> TextUtils.parseDuration(s.trim()));
	public static final AnvilInputValidator<LocalDateTime> VALIDATE_DATE_TIME = new AnvilInputValidator<>(Messages.ERROR_PARSE_DATE,
